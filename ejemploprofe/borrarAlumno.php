    ...
    <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading">Borrar Alumno</h2>
          </div>
        </div>
        <div class="row">
         <div class="col-lg-12">
           <form id="apuntateAlu" name="apuntateAlu" method="POST" action="rborrarAlumno.php">
             <div class="row">
               <div class="col-md-12">
                  <div class="form-group">
                    <b>Seguro que desea borrar el alumno:</b><?=utf8_encode($nombre)?>
                    <input class="form-control" id="email" name="email" type="hidden"  value="<?php echo $email?>">
                ...
                <div class="col-lg-12 text-center">
                <div id="success"></div>
                  <button id="apuntate2" class="btn btn-xl" type="submit">Borrar Alumno</button>
                </div>
              </div>
          </form>
         </div>
